...
const Dashboard = () => {
  ...
  const socket = useMemo(
    () => io("https://chat-application-server-i0fq.onrender.com"),
    []
  );
  ...
  useEffect(() => {
    axios
      .get(
        `https://chat-application-server-i0fq.onrender.com/getSingaluser/${user?.email}`
      )
      .then((res) => setShowUser(res.data))
      .catch((err) => console.log(err));
    axios
      .get(
        `https://chat-application-server-i0fq.onrender.com/findReciver/${user?.email}`
      )
      .then((res) => {
    ...
    axios
      .get(
        `https://chat-application-server-i0fq.onrender.com/getAllUser/${user?.email}`
      )
      .then((res) => {
        setAllUser(res.data);
      });
  ...
  const handelMessage = (item) => {
    ...
    axios
      .get(
        `https://chat-application-server-i0fq.onrender.com/message/${item?.conversionid}`
      )
      .then((res) => {
        setMessage(res.data);
      });
  ...
  const messageSend = () => {
    ...
    axios
      .post(
        "https://chat-application-server-i0fq.onrender.com/message",
        messageDatas
      )
      .then((res) => {
  ...
  const createConversition = (senderId, receverId) => {
    axios
      .post(`https://chat-application-server-i0fq.onrender.com/conversations`, {
        senderId,
        receverId,
      })
      .then((res) => {
